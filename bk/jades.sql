...
insert into ja_users values(null, "yangshuang", "1876484@qq.com", "123456", 0),
...
create table ja_class(
	...
	class_id int,#分类ID
	cname varchar (30),#分类名字
	cpic varchar (50),#分类图片
	islocal int # 是否在头部的分类 
);
insert into ja_class
values(null, 0, '和田玉', 'http://127.0.0.1:10000/img/tab/hetianyu.png', 1),
	(null, 1, '独山玉', 'http://127.0.0.1:10000/img/tab/dushanyu.png', 1),
	(null, 2, '翡翠', 'http://127.0.0.1:10000/img/tab/hetianyu.png', 1),
	(null, 3, '玛瑙', 'http://127.0.0.1:10000/img/tab/feicui.png', 1),
	(null, 4, '水晶', 'http://127.0.0.1:10000/img/tab/shuijing.png', 1),
	(null, 5, '碧玉', '', 0),
	(null, 6, '手镯', '', 0),
	(null, 7, '挂件', '', 0),
	(null, 8, '玉牌', '', 0),
